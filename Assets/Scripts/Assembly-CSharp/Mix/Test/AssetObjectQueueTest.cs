...
namespace Mix.Test
{
	public class AssetObjectQueueTest : MonoBehaviour, IOperationCompleteHandler
	{
		...
		private void Start()
		{
			...
			AssetObjectQueueTestHelper assetObjectQueueTestHelper = new AssetObjectQueueTestHelper(operationStack, this);
			...
			dictionary[assetObjectQueueTestHelper] = new List<SequenceOperation> { item3, item2, item, cpipeUpdateOperation, assetManagerStartOperation };
			...
			operationStack.Add(assetObjectQueueTestHelper);
