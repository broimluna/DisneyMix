...
namespace Mix.Ui
{
	public class TransitionSlideDown : BaseNavigationTransition
	{
		...
		public TransitionSlideDown(bool aLockCurrent = false, float aSpeed = 10f)
		{
		...
		public override void Start(ScreenHolder aNewScreen)
		{
			...
			newScreen.Position = new Vector2(0f, MixConstants.CANVAS_HEIGHT);
			oldEndPosition = new Vector2(0f, 0f - MixConstants.CANVAS_HEIGHT);
