...
namespace Disney.LaunchPad.Packages.FiniteStateMachine
{
	...
	{
		public StateTraverser Traverser { get; set; }

		public State StartState { get; set; }

		public State EndState { get; set; }

		public Signal TriggeringSignal { get; set; }

		public Transition TransitionUsed { get; set; }
		...
		public StateChangeArgs Clone()
		{
			return MemberwiseClone() as StateChangeArgs;
		}
	}
}
