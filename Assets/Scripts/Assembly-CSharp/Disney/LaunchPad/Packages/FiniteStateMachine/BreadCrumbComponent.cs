...
namespace Disney.LaunchPad.Packages.FiniteStateMachine
{
	public class BreadCrumbComponent : StateTraverserComponent
	{
		...
		private StateTraverser mTraverser;
		...
		public void Start()
		{
			...
			{
				mTraverser = base.gameObject.GetComponent<StateTraverser>();
				if (mTraverser != null)
				{
		...
		public void OnGUI()
		{
			...
			startRect = GUI.Window(GUIUtility.GetControlID(FocusType.Passive), startRect, RenderWindow, string.Empty);
		}
