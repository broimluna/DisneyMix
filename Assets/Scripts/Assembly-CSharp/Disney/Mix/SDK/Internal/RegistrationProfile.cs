...
namespace Disney.Mix.SDK.Internal
{
	public class RegistrationProfile : IInternalRegistrationProfile, IRegistrationProfile
	{
		...
		public DateTime? DisplayNameModeratedStatusDate { get; private set; }

		public string ProposedDisplayName { get; private set; }

		public DisplayNameProposedStatus DisplayNameProposedStatus { get; private set; }

		public AccountStatus AccountStatus { get; private set; }

		public string AgeBandKey { get; private set; }

		public bool AgeBandAssumed { get; private set; }
		...
		public bool ParentEmailVerified { get; private set; }
		...
		public IEnumerable<KeyValuePair<string, bool>> MarketingItems { get; private set; }
		...
		private void UpdateMarketing(IEnumerable<Disney.Mix.SDK.Internal.GuestControllerDomain.MarketingItem> marketing)
		{
			...
			if (marketing == null)
			{
				IEnumerable<KeyValuePair<string, bool>> enumerable = null;
				marketingItems = enumerable;
			}
			else
			{
