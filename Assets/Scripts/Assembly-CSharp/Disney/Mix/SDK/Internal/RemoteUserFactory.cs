namespace Disney.Mix.SDK.Internal
{
	...
	{
		public static IInternalRemoteChatMember CreateRemoteChatMember(string swid, string displayNameText, string firstName, IUserDatabase userDatabase)
		{
			DisplayName displayName = new DisplayName(displayNameText);
			return new RemoteChatMember(swid, displayName, firstName, userDatabase);
		}
