...
namespace Disney.Mix.SDK.Internal
{
	public interface IGuestControllerClient : IDisposable
	{
		...
		void RecoverPassword(RecoverRequest request, Action<GuestControllerResult<NotificationResponse>> callback);

		void RecoverUsername(RecoverRequest request, Action<GuestControllerResult<NotificationResponse>> callback);

		void ResolveMase(RecoverRequest request, Action<GuestControllerResult<NotificationResponse>> callback);

		void UpgradeNrt(RecoverRequest request, Action<GuestControllerResult<NotificationResponse>> callback);

		void SendParentalApprovalEmail(Action<GuestControllerResult<NotificationResponse>> callback);

		void SendVerificationEmail(Action<GuestControllerResult<NotificationResponse>> callback);
