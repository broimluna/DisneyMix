...
{
	public class KochavaManager : MonoBehaviour, IInitializable, IPlugin
	{
		...
		public void Init()
		{
			...
			kochava.kochavaAppId = EnvironmentManager.BundleIdentifier;
			Logger.LogDebug(this, "KochavaManager initialized!! id = " + kochava.appVersion + " ver = " + kochava.appVersion);
		}
	}
}
