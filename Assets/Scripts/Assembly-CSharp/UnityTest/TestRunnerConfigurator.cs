...
namespace UnityTest
{
	public class TestRunnerConfigurator
	{
		...
		public static List<string> GetAvailableNetworkIPs()
		{
			...
			if (!list2.Any())
			{
				return list3.Select((UnicastIPAddressInformation unicastIPAddressInformation) => unicastIPAddressInformation.Address.ToString()).ToList();
			}
			...
			return list2.Select((UnicastIPAddressInformation unicastIPAddressInformation) => unicastIPAddressInformation.Address.ToString()).ToList();
		}
