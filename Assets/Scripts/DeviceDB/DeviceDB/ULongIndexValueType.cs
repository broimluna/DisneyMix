namespace DeviceDB
{
	internal class ULongIndexValueType : AbstractFixedIndexValueType<ulong>
	{
		...
		protected override byte[] Serialize(ulong entryValue)
		{
			...
			buffer[3] = (byte)((entryValue & 0xFF000000u) >> 24);
			buffer[4] = (byte)((entryValue & 0xFF00000000L) >> 32);
			buffer[5] = (byte)((entryValue & 0xFF0000000000L) >> 40);
			buffer[6] = (byte)((entryValue & 0xFF000000000000L) >> 48);
			buffer[7] = (byte)((entryValue & 0xFF00000000000000uL) >> 56);
			return buffer;
		}
